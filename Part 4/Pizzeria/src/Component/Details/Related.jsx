...
import PizzaCard from "../Home/PizzaCard.jsx";
  ...
  return (
    <div>
      <div className="flex items-end justify-between gap-4">
        <div>
          <p className="text-2xl font-bold font-main">You may also like</p>
          <p className="text-textSecClr dark:text-textSecClrDark">
            More delicious options for you
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            className="related-prev border border-orange-500/40 dark:border-orange-600/40 hover:text-orange-500 cursor-pointer p-3 rounded-full hover:border=orange-500/80 dark:hover:border-orange-600/80 transition"
            aria-label="Previous"
          >
            <ChevronLeft />
          </button>
          <button
            className="related-next border border-orange-500/40 dark:border-orange-600/40 hover:text-orange-500 cursor-pointer p-3 rounded-full hover:border=orange-500/80 dark:hover:border-orange-600/80 transition"
            aria-label="Next"
          >
            <ChevronRight />
          </button>
