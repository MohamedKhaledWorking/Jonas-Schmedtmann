    ...
    <>
      <div className="container mx-auto capitalize text-mainClr dark:text-mainClrDark pt-30">
        ...
        <div className="mt-20 flex justify-center">
          <button className="mx-2 rounded-full px-8 py-2 bg-orange-700 hover:bg-transparent border border-orange-700 hover:ring-3 hover:ring-orange-700 ring-offset-mainBgc dark:ring-offset-mainBgcDark hover:ring-offset-3 cursor-pointer duration-400  ">
            All
          </button>
          <button className="mx-2 rounded-full px-8 py-2 bg-orange-700 hover:bg-transparent border border-orange-700 hover:ring-3 hover:ring-orange-700 ring-offset-mainBgc dark:ring-offset-mainBgcDark hover:ring-offset-3 cursor-pointer duration-400  ">
            Vegetarian
