...
import { Circle, Code, File, Dock, TableCellsSplit } from "lucide-react";
...
const DEFAULT_ITEMS = [
  ...
  },
  {
    ...
    id: 3,
    icon: <Dock className="h-[16px] w-[16px] text-white" />,
  },
  {
    title: "Backgrounds",
    description: "Beautiful backgrounds and patterns for your projects.",
    id: 4,
    icon: <TableCellsSplit className="h-[16px] w-[16px] text-white" />,
  },
  {
    title: "Common UI",
